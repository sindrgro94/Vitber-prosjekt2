...
if sqrt(xPos(length(t))^2+yPos(length(t))^2) <= r0/2 %regner med at vi skal bruke dette i en forløkke senere en gang. 
    fprintf('Den kom gjennom \n')                    %Det som skrives ut er ikke viktig, bare at det kommer noe når partiklen treffer sensoren
end
